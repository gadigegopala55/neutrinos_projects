export default {
    "db-config": {
        "sd_z1hHi1Sesg8SeX6u": {
            ...
            "postgres_host": process.env.HOST_NAME,
            "postgres_port": process.env.PORT_NUMBER,
    ...
    "emailout-config": {
        "sd_RPVwySyFdRxV15nL": {
            ...
            "tls": false,
            "secure": false,
            "userid": "demomail224@gmail.com",
            "password": "xcxhvjueqqczndye",
            "category": "config",
            "__ssdTypeInputs__": {
                "server": {
                    "type": "str",
